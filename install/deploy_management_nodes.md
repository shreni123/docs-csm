...
firmware requirement before starting.
   ...
   See the 1.5 HPE Cray EX System Software Getting Started Guide `S-8000` on
   the [HPE Customer Support Center](https://www.hpe.com/support/ex-gsg) for information about the HPE Cray EX HPC Firmware Pack (HFP) product.
